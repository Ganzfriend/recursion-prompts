...
// Input: array
// Output: integer
// Edge cases: initial array empty, base case
// if current elment is an array, call arraySum on it
// underscore options of reduce or flatten
...
// input: string
// output: new string
// edge case: not a string (didn't mess with this edge case)
